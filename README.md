...
Update the venv path and the Python entrypoint to match a tracked script like `wqbagent_embedding.py` or `wqbagent_output_test.py`, or your notebook export.
